...
and then the netcat (nc) program turns the c program mdb-lookup-cs3157 into a network server from CLAC. The named pipe is removed at the end of the script.
